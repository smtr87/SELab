...
public class  ChatRoom
{
    ...
    // source file because it is used by both the  server and
    ...
    pubchalic Vector bannedUserNames;
   
    private FileOutputStream chatLogStream;

     ChatRoom(String myName, String myCreator, boolean isPrivate,
		    String myPassword)
    {
	name = myName;
    ...
    public void addClient( ClientSocket newClient)
    {
    ...
    public void remClient( ClientSocket oldClient)
    {
